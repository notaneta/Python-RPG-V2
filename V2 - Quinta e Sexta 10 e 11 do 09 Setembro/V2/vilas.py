...
# Vilas
vila5_finalverdadeiro = Vilas("")
vila4_destruida = Vilas("Aldeia Destruida", "Aldeia que foi destruida", bossnecessario=4 , proximavila=1, eventos = [evento_sombra])   # Tem um evento de raid de bosses caso o jogador passe, ele ganha um drop lendário
...
def ferreiro(heroi):    # Testar depois se consigo criar IF para verificar em qual a vila que estou, e dependendo dela, aparece alguma opção ou item adicional / OPÇÃO CHAMADA item exclusivo da vila / verifica antes a vila atual e muda o catalogo referente a ela
    ...
    if item_raid_vila == True:
        print("============ FERREIRO ============")
        print("Você mostra o material que coletou na vila destruida ao ferreiro, ele faz uma nova ESPADA")
